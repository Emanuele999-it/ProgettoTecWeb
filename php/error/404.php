...
$setterPagina->setDescription("Pagina iniziale errore 404");

$setterPagina->setPercorso("Errore 404");
...
$contenuto = str_replace("<segnapostoErrore />", "Ops.. sembra che il file non esista", file_get_contents(__DIR__ . "/../contents/erroreContent.php"));
