<div id="header">
    <img  id="logo" src="<correzioneLink />img/logo-spaziogames.png" alt="Logo sito The Darksoulers"/>
    ...
    <div id="menu" >
        ...
        <ul id="listaMenu">
            ...
            <li class="elementomenu"><a href="<correzioneMenu />top10.php">Top 10</a></li>
            <li class="elementomenu"><a href="<correzioneMenu />nuoveuscite.php">Nuove Uscite</a></li>
    ...
    <div id="breadcrumb">
        <p tabindex="0"> Il tuo percorso: <span xml:lang="en">Home</span> </p>  
    </div>  
